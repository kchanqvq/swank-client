...
function Client(host, port) {
  ...
  this.on_handlers = {
    ...
    indentation_update: function(indents) {},
    disconnect: function() {}
  };
...
Client.prototype.on_swank_message = function(msg) {
  ...
  if (cmd == ":return") {
    ...
    this.on_handlers.print_string(util.from_lisp_string(sexp.children[1]),
      sexp.children[2].source.toLowerCase());
  ...
  } else if (cmd == ':indentation-update') {
    this.on_handlers.indentation_update(sexp.children[1]);
  } else {
